...
const Faq = () => {
    ...
    const [ctaText, setCtaText] = useState('Stop bothering my co-workers');
            ...
            <Flex w='100%' justify='center'>
                <Accordion 
                    ...
                    <AccordionItem py='10px' borderTop='none' borderBottomWidth='2px'>
                        <Heading as='h2' color={styles.colorWhite} _hover={{opacity: '.5', backGround:'none', transition: '.5s'}} fontFamily='body'>
                            <AccordionButton _hover={{backGround: 'transparent'}}>
                                <Text as='span' fontSize={{base: '28px', sm: '32px', md: '40px'}} textAlign='start'>Why did I choose for Bravoure?</Text>
                            </AccordionButton>
                        </Heading>
                        <AccordionPanel fontFamily='body'>
                            <Text as='p' fontSize={{base: '20px', md: '25px'}} color={styles.colorWhite}>
                                Because I wanted to learn more about coding while keeping creativity in mind,
                                and because of the drinks and other fun activities ;)
                            </Text>
                        </AccordionPanel>
                    </AccordionItem>
                    <AccordionItem py='10px' borderTop='none' borderBottomWidth='2px'>
                        <Heading as='h2' color={styles.colorWhite} _hover={{opacity: '.5', backGround:'none', transition: '.5s'}} fontFamily='body'>
                            <AccordionButton _hover={{backGround: 'transparent'}}>
                                <Text as='span' fontSize={{base: '28px', sm: '32px', md: '40px'}} textAlign='start' fontFamily='body'>Favourite kind of music?</Text>
                            </AccordionButton>
                        </Heading>
                        <AccordionPanel>
                    ...
                    <AccordionItem py='10px' borderTop='none' borderBottomWidth='2px'>
                        <Heading as='h2' color={styles.colorWhite} _hover={{opacity: '.5', backGround:'none', transition: '.5s'}} fontFamily='body'>
                            <AccordionButton _hover={{backGround: 'transparent'}}>
                                <Text as='span' fontSize={{base: '28px', sm: '32px', md: '40px'}} textAlign='start'>Any quirky habits?</Text>
                            </AccordionButton>
                        </Heading>
                        <AccordionPanel>
                            <Text as='p' fontSize={{base: '20px', md: '25px'}} color={styles.colorWhite} fontFamily='body'>
                    ...
                    <AccordionItem py='10px' borderTop='none' borderBottomWidth='2px !important'>
                        <Heading as='h2' color={styles.colorWhite} _hover={{opacity: '.5', backGround:'none', transition: '.5s'}} fontFamily='body'>
                            <AccordionButton _hover={{backGround: 'transparent'}}>
                                <Text as='span' fontSize={{base: '28px', sm: '32px', md: '40px'}} textAlign='start'>Any spirit animal?</Text>
                            </AccordionButton>
                        </Heading>
                        <AccordionPanel>
                            <Text as='p' fontSize={{base: '20px', md: '25px'}} color={styles.colorWhite} fontFamily='body'>
                                Every bird that dances to impress the ladies.
                            </Text>
                        </AccordionPanel>
                    </AccordionItem>
                </Accordion>
